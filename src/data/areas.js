...
export const AREAS = [
  {
    ...
    body: [
      ...
      { cta: true },
      { button: { text: 'Get a FREE Site Assessment' } },
  ...
  },
  {
    ...
    metaDescription:
      'Looking for a trusted digital marketing & SEO expert in Echo Park CA? Gobiya SEO builds fast websites and content that ranks. Call now for a free site assessment!',
    body: [
  ...
  },
  {
    ...
    metaDescription:
      'Searching for a reliable digital marketing & SEO expert in Los Feliz CA? Gobiya SEO provides affordable website and SEO services. Call now for a free site assessment!',
    body: [
  ...
  },
  {
    ...
    metaDescription:
      'Looking for a reliable internet marketing & SEO expert in Sherman Oaks CA? Gobiya SEO provides affordable website and AI SEO services. Call now for a free site assessment!',
    body: [
    ...
    details: [
      ...
      'We provide technical SEO assessments, Google Business Profile recovery, and PPC management for Sherman Oaks businesses.',
  ...
  },
  {
    ...
    metaDescription:
      'Looking for a reliable website & SEO expert in Koreatown LA? Gobiya SEO builds sites that rank and content that converts. Call today for a free site assessment!',
    body: [
    ...
    body: [
      ...
      { h4: 'We can help you with:' },
      {
        list: [
          ...
          'Website design, redesign, upgrades, and migrations',
          'AI-ready content',
          'Technical SEO assessments and site health monitoring',
          'Local SEO and Google Business Profile management',
          'Link building and digital PR',
